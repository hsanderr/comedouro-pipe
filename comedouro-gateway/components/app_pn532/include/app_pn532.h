...
/**
 * PN532 Commands according to PN532 user manual rev. 2:
 * - https://www.nxp.com/docs/en/user-guide/141520.pdf (online)
 * - docs/3rd-party/pn532_user_manual_rev2.pdf (local)
 */
...
#define PN532_GPIO_P35 (5)
    ...
    void pn532__spi_init(pn532_t *obj, uint8_t clk, uint8_t miso, uint8_t mosi, uint8_t ss);
